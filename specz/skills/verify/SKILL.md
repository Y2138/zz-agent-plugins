...
<constraint>
    ...
    <content>Verification MUST be grounded in spec.md first, then checklist.md, test-cases.md, real test results, and observed behavior from the implemented system.</content>
</constraint>
<constraint>
...
<constraint>
    ...
    <content>Do not silently modify spec.md. If verification reveals scope ambiguity or a requirement conflict, return the issue to the add skill or the user.</content>
</constraint>

# Purpose

`verify` is the final verification-stage Specz skill. It is responsible for proving that the implementation satisfies `spec.md` from test design through final observed behavior.
...
5. Do not change `spec.md`; escalate ambiguity back to planning.
